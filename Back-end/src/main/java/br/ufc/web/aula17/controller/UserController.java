...
public class UserController {
	...
	public ResponseEntity<User> addUser(@RequestBody User user) {
		return new ResponseEntity<User>(
				userService.addUser(user.getCpf(), user.getSenha(), user.getNome(), user.getEmail(), user.getTelefone(), user.getEstado(), user.getCidade(), user.getComplemento()),
				HttpStatus.OK);
	}

	@RequestMapping(method = RequestMethod.PUT, value = "{id}")
	public ResponseEntity<User> updateUser(@PathVariable("id") Integer id, @RequestBody User user) {
		return new ResponseEntity<User>(userService.updateUser(id, user.getCpf(), user.getSenha(),
				user.getNome(), user.getEmail(), user.getTelefone(), user.getEstado(), user.getCidade(), user.getComplemento()), HttpStatus.OK);
	}
