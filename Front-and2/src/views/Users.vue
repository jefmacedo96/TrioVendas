        ...
        <main>
          <form action="" id="create-registration" onsubmit= "return validaCadastro()">
            <fieldset>
                <legend>Insira seus dados</legend>
                    ...
                    <div class="input-block">
                        ...
                        <input id="cpf" type="number" v-model="login" placeholder="xxx.xxx.xxx-xx" required="required">
                    </div>
                    <div class="input-block">
                        <label for="telefone">Telefone <small>(somente números)</small></label>
                        <input name="telefone" id="telefone" v-model="telefone" placeholder="(DDD) xxxxx - xxxx" type="number" required="required">
                    </div>
            </fieldset>
            <fieldset>
                ...
                <div class="input-block" id="input-block2">
                    <input name="estado" id="subject" v-model="estado" type="text" required="required">
                </div>
                <div class="select-block">
                    <label for="cidade">Cidade</label>
                </div>
                <div class="input-block" id="input-block2">
                    <input name="cidade" id="subject" v-model="cidade" type="text" required="required">
                </div>
                ...
                <div class="input-block" id="input-block2">
                    <input name="complemento" id="complemento" v-model="complemento" type="text" required="required">
                </div>
            </fieldset>
            <fieldset>
                <legend>Estamos quase lá</legend>
                    <div class="input-block" id="input-block3" >
                        ...
                        <input name="senha" id="senha" v-model="password" type="password" required="required">
                         <label for="senha">Digite novamente</label>
                        <input name="confirmeSenha" v-model="confirmeSenha" id="confirmeSenha" type="password" required="required">
                        <span class="eye2">
                           <img @click="mostrarSenha" src="/../assets/eye.png" alt="Mostrar senha"> 
                        </span>
                         <span class="eye">
                           <img @click="mostrarConfirmeSenha" src="/../assets/eye.png" alt="Mostrar senha"> 
                        </span>
                    </div>
            </fieldset>
          </form>
            <footer>
                ...
                <button type="submit" form="create-registration" @click="validaCadastro()">Salvar cadastro</button>
